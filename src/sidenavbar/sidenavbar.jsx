...
import resume from "../assets/LeninBevan-Resume.pdf";
      ...
      <div className="container">
        ...
        <div className=" row sticky-top  d-lg-none bg-white">
          <div className="d-flex pt-2 pb-2 d-flex justify-content-between navhead">
            <div className="fs-3 fw-medium">Lenin Bevan C</div>
          ...
          >
            <Offcanvas.Header closeButton className="">
              <Offcanvas.Title>Lenin Bevan C</Offcanvas.Title>
            </Offcanvas.Header>
        ...
        <div className="row d-flex align-items-start">
          ...
          <div className="col-lg-4 col-xl-3  sidebar sticky-top d-none d-lg-block p-0">
            ...
            <div className="d-flex justify-content-center">
              <div className="imgdiv">
                <img src={lenin} className="img-fluid"></img>
              </div>
            </div>
          ...
          <div className="col-lg-7 p-0 ms-lg-5 mt-3" id="home">
              ...
              <div className=" wrapper">
                <div className="text-white d-flex justify-content-center flex-column aligin-item-center mt-5">
                  <h2
                    ...
                    style={{ color: "rgb(208 144 0)", fontWeight: "600" }}
                  >
                    HI, I'M LENIN BEVAN
                  </h2>
                  ...
                  <div>
                    <div className="d-flex justify-content-center  aligin-item-center  mt-5 mb-4 flex-column flex-sm-row">
                      <div className="topbtn">
                        <button className="button me-sm-4 mb-4 mb-sm-0">
            ...
            {/* ******** About start ********* */}
            <div
              className="row ms-0 me-0 mt-5 mb-5 p-3 p-sm-5 item aboutDiv"
              id="about"
              data-aos="zoom-in"
            ...
            {/* ******* Skills start ******* */}
            <div
              className="row ms-0 me-0 mt-5 mb-5 p-sm-5 item skilDiv"
              id="skill"
              style={{ boxShadow: "0 0.5rem 1rem rgba(0, 0, 0, 0.15)" }}
            >
              <Myskills />
            ...
            {/* ******* Education start ******* */}
            <div
              className="row ms-0 me-0 mt-5 mb-5 p-sm-5 item educationDiv"
              id="education"
              style={{ boxShadow: "0 0.5rem 1rem rgba(0, 0, 0, 0.15)" }}
            >
              <Education />
            ...
            {/* ******* My portfolio start ******* */}
            <div
              className="row ms-0 me-0 mt-5 mb-5 p-sm-5 item portfolioDiv"
              id="portfolio"
              style={{ boxShadow: "0 0.5rem 1rem rgba(0, 0, 0, 0.15)" }}
            >
              <Portfolio />
            ...
            {/* ******* Countact Us start ************ */}
            <div
              className="row ms-0 me-0 mt-5 mb-2 p-sm-5 item contactDiv"
              id="contact"
